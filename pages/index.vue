...
const { data: culinaryResult } = await useFetch(`/api/v1/home/culinary/`, {
  baseURL: 'https://freyja-wtj7.onrender.com/',
  method: 'GET',
});
culinaryData.value = culinaryResult?._value?.result;
</script>
          ...
          >
            <div class="card position-relative border-0 rounded-3">
              <picture>
                ...
                <img class="w-100 rounded-3" :src="culinary.image" alt="海霸" />
              </picture>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <span class="fw-bold"
                      >{{ culinary.diningTime.split(' ')[0] }}</span
                    >
