          ...
          <div class="d-flex flex-wrap gap-md-2" style="width: 42.5vw">
            <div class="d-flex gap-md-2">
              <img
                ...
                :key="idx"
                class="w-50"
                :src="roomData.imageUrlList[i]"
                :alt="`room-${roomData.name}-${idx}`"
              />
            </div>
            <div class="d-flex gap-md-2">
              <img
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-7 d-flex flex-column gap-6 gap-md-20">
            <div>
              <h1 class="mb-4 text-neutral-100 fw-bold">{{ roomData.name }}</h1>
            ...
            <section>
              ...
              <ul class="d-flex gap-4 list-unstyled">
                ...
                >
                  ...
                  />
                  <p class="mb-0 fw-bold text-neutral-80 text-nowrap">
                    {{ roomData.maxPeople <= 4 ? '2-4人' : '超過4人' }}
                  </p>
                </li>
              </ul>
            </section>
          ...
          <div class="d-none d-md-block col-md-5">
            <Form v-slot="{ errors }" @submit="handleBookingData">
              <div
              ...
              >
                ...
                <div class="text-neutral-80">
                  <h2 class="fw-bold">{{ roomData.name }}</h2>
                ...
                <div>
                  <div class="d-flex flex-wrap gap-2 mb-4">
                    <div class="form-floating flex-grow-1 flex-shrink-1">
                      ...
                      <ErrorMessage class="invalid-feedback" name="入住" />
                    </div>
                    ...
                    <div class="form-floating flex-grow-1 flex-shrink-1">
                      ...
                      <ErrorMessage class="invalid-feedback" name="退房" />
                    </div>
                  </div>
